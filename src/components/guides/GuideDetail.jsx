...
const themes = {
  ...
  'no-dig-gardening': {
    heroBg: 'bg-gradient-to-br from-emerald-50 to-teal-100',
    heroBorder: 'border-emerald-200',
    heroTitle: 'text-emerald-800',
    backBtn: 'text-emerald-700 hover:text-emerald-900',
    sectionTitle: 'text-emerald-800',
  ...
  'seed-saving': {
    heroBg: 'bg-gradient-to-br from-emerald-50 to-lime-100',
    heroBorder: 'border-emerald-200',
    heroTitle: 'text-emerald-800',
    backBtn: 'text-emerald-700 hover:text-emerald-900',
    sectionTitle: 'text-emerald-800',
  ...
  'soil-health': {
    heroBg: 'bg-gradient-to-br from-amber-50 to-stone-200',
    heroBorder: 'border-stone-300',
    heroTitle: 'text-stone-800',
    backBtn: 'text-stone-700 hover:text-stone-900',
    sectionTitle: 'text-stone-800',
    ...
    tipBorder: 'border-stone-300',
    tipText: 'text-stone-900',
    tableHead: 'bg-stone-200',
    tableHeadText: 'text-stone-800',
    tableHeadBorder: 'border-stone-300',
    bullet: 'text-amber-700',
  },
  'organic-pest-control': {
    heroBg: 'bg-gradient-to-br from-lime-50 to-emerald-100',
    heroBorder: 'border-lime-200',
    heroTitle: 'text-emerald-800',
    backBtn: 'text-emerald-700 hover:text-emerald-900',
    sectionTitle: 'text-emerald-800',
  ...
  'slug-control': {
    heroBg: 'bg-gradient-to-br from-slate-50 to-cyan-100',
    heroBorder: 'border-slate-200',
    heroTitle: 'text-slate-800',
    backBtn: 'text-slate-700 hover:text-slate-900',
    sectionTitle: 'text-slate-800',
  ...
  'deer-resistant': {
    ...
    heroBorder: 'border-amber-200',
    heroTitle: 'text-amber-900',
    backBtn: 'text-amber-800 hover:text-amber-950',
    ...
    tableHead: 'bg-amber-100',
    tableHeadText: 'text-amber-900',
    tableHeadBorder: 'border-amber-200',
    bullet: 'text-orange-600',
  },
  'pest-eliminating-plants': {
    heroBg: 'bg-gradient-to-br from-green-50 to-teal-100',
    heroBorder: 'border-green-200',
    heroTitle: 'text-green-900',
    backBtn: 'text-green-800 hover:text-green-950',
    sectionTitle: 'text-green-900',
    sectionBorder: 'border-green-100',
    h3: 'text-green-900',
    tipBg: 'bg-teal-50',
    tipBorder: 'border-teal-200',
    tipText: 'text-green-950',
    tableHead: 'bg-teal-100',
    tableHeadText: 'text-green-900',
    tableHeadBorder: 'border-teal-200',
    bullet: 'text-teal-600',
  },
  'balcony-garden': {
    heroBg: 'bg-gradient-to-br from-sky-50 to-slate-100',
    heroBorder: 'border-sky-200',
    heroTitle: 'text-slate-800',
    backBtn: 'text-slate-700 hover:text-slate-900',
    sectionTitle: 'text-slate-800',
  ...
  'window-box': {
    heroBg: 'bg-gradient-to-br from-rose-50 to-orange-100',
    heroBorder: 'border-rose-200',
    heroTitle: 'text-rose-900',
    backBtn: 'text-rose-800 hover:text-rose-950',
    sectionTitle: 'text-rose-900',
    sectionBorder: 'border-rose-100',
    h3: 'text-rose-900',
    tipBg: 'bg-orange-50',
    tipBorder: 'border-orange-200',
    tipText: 'text-rose-950',
    tableHead: 'bg-orange-100',
    tableHeadText: 'text-rose-900',
    tableHeadBorder: 'border-orange-200',
    bullet: 'text-orange-500',
  },
  'hanging-baskets': {
    heroBg: 'bg-gradient-to-br from-fuchsia-50 to-purple-100',
    heroBorder: 'border-fuchsia-200',
    heroTitle: 'text-fuchsia-900',
    backBtn: 'text-fuchsia-800 hover:text-fuchsia-950',
    sectionTitle: 'text-fuchsia-900',
    sectionBorder: 'border-fuchsia-100',
    h3: 'text-fuchsia-900',
    tipBg: 'bg-purple-50',
    tipBorder: 'border-purple-200',
    tipText: 'text-fuchsia-950',
    tableHead: 'bg-purple-100',
    tableHeadText: 'text-fuchsia-900',
    tableHeadBorder: 'border-purple-200',
    bullet: 'text-fuchsia-500',
  },
  'container-vegetables': {
    heroBg: 'bg-gradient-to-br from-lime-50 to-yellow-100',
    heroBorder: 'border-lime-200',
    heroTitle: 'text-lime-900',
    backBtn: 'text-lime-800 hover:text-lime-950',
    sectionTitle: 'text-lime-900',
    sectionBorder: 'border-lime-100',
    h3: 'text-lime-900',
    tipBg: 'bg-yellow-50',
    tipBorder: 'border-yellow-200',
    tipText: 'text-lime-950',
    tableHead: 'bg-lime-100',
    tableHeadText: 'text-lime-900',
    tableHeadBorder: 'border-lime-200',
    bullet: 'text-lime-600',
  },
  'cutting-garden': {
    heroBg: 'bg-gradient-to-br from-rose-50 to-purple-100',
    heroBorder: 'border-rose-200',
    heroTitle: 'text-purple-900',
    backBtn: 'text-purple-800 hover:text-purple-950',
    ...
    tableHead: 'bg-rose-100',
    tableHeadText: 'text-purple-900',
    tableHeadBorder: 'border-rose-200',
    bullet: 'text-rose-500',
  },
  'fragrant-garden-path': {
    heroBg: 'bg-gradient-to-br from-violet-50 to-purple-200',
    heroBorder: 'border-violet-200',
    heroTitle: 'text-violet-900',
    backBtn: 'text-violet-800 hover:text-violet-950',
    sectionTitle: 'text-violet-900',
    sectionBorder: 'border-violet-100',
    h3: 'text-violet-900',
    tipBg: 'bg-violet-50',
    tipBorder: 'border-violet-200',
    tipText: 'text-violet-950',
    tableHead: 'bg-violet-100',
  ...
  'bird-garden': {
    heroBg: 'bg-gradient-to-br from-sky-50 to-amber-100',
    heroBorder: 'border-sky-200',
    heroTitle: 'text-sky-900',
    backBtn: 'text-sky-800 hover:text-sky-950',
    sectionTitle: 'text-sky-900',
    sectionBorder: 'border-sky-100',
    h3: 'text-sky-900',
    tipBg: 'bg-amber-50',
    tipBorder: 'border-amber-200',
    tipText: 'text-sky-950',
    tableHead: 'bg-sky-100',
  ...
  'water-feature-plants': {
    heroBg: 'bg-gradient-to-br from-cyan-50 to-blue-100',
    heroBorder: 'border-cyan-200',
    heroTitle: 'text-blue-900',
    backBtn: 'text-blue-800 hover:text-blue-950',
    sectionTitle: 'text-blue-900',
    sectionBorder: 'border-cyan-100',
    h3: 'text-blue-900',
    tipBg: 'bg-cyan-50',
  ...
  'native-plants': {
    heroBg: 'bg-gradient-to-br from-emerald-50 to-amber-100',
    heroBorder: 'border-emerald-200',
    heroTitle: 'text-emerald-900',
    backBtn: 'text-emerald-800 hover:text-emerald-950',
  ...
  'water-wise-gardening': {
    heroBg: 'bg-gradient-to-br from-sky-50 to-emerald-100',
    heroBorder: 'border-sky-200',
    heroTitle: 'text-sky-900',
    backBtn: 'text-sky-800 hover:text-sky-950',
    sectionTitle: 'text-sky-900',
  ...
  'vertical-gardening': {
    heroBg: 'bg-gradient-to-br from-lime-50 to-teal-100',
    heroBorder: 'border-lime-200',
    heroTitle: 'text-teal-900',
    backBtn: 'text-teal-800 hover:text-teal-950',
    sectionTitle: 'text-teal-900',
    sectionBorder: 'border-lime-100',
    h3: 'text-teal-900',
    tipBg: 'bg-lime-50',
    tipBorder: 'border-lime-200',
    tipText: 'text-teal-950',
    tableHead: 'bg-teal-100',
    tableHeadText: 'text-teal-900',
    tableHeadBorder: 'border-teal-200',
    bullet: 'text-lime-600',
  },
  'foundation-planting': {
  ...
  'cottage-landscape': {
    heroBg: 'bg-gradient-to-br from-pink-50 to-rose-200',
    heroBorder: 'border-pink-200',
    heroTitle: 'text-rose-900',
    backBtn: 'text-rose-800 hover:text-rose-950',
    sectionTitle: 'text-rose-900',
  ...
  'low-maintenance-landscape': {
    heroBg: 'bg-gradient-to-br from-slate-50 to-emerald-100',
    heroBorder: 'border-slate-200',
    heroTitle: 'text-slate-800',
    backBtn: 'text-slate-700 hover:text-slate-900',
    sectionTitle: 'text-slate-800',
  ...
  'pet-friendly-plants': {
    heroBg: 'bg-gradient-to-br from-amber-50 to-lime-100',
    heroBorder: 'border-amber-200',
    heroTitle: 'text-lime-900',
    backBtn: 'text-lime-800 hover:text-lime-950',
    sectionTitle: 'text-lime-900',
  ...
  'sensory-garden': {
    heroBg: 'bg-gradient-to-br from-violet-50 to-fuchsia-100',
    heroBorder: 'border-violet-200',
    heroTitle: 'text-violet-900',
    backBtn: 'text-violet-800 hover:text-violet-950',
    sectionTitle: 'text-violet-900',
  ...
  'fire-safe-landscaping': {
    ...
    heroBorder: 'border-orange-200',
    heroTitle: 'text-red-900',
    backBtn: 'text-red-800 hover:text-red-950',
  ...
  'summer-maintenance': {
    heroBg: 'bg-gradient-to-br from-yellow-50 to-orange-100',
    heroBorder: 'border-yellow-200',
    heroTitle: 'text-orange-900',
    backBtn: 'text-orange-800 hover:text-orange-950',
    sectionTitle: 'text-orange-900',
    sectionBorder: 'border-yellow-100',
    h3: 'text-orange-900',
    tipBg: 'bg-yellow-50',
    tipBorder: 'border-yellow-200',
    tipText: 'text-orange-950',
    tableHead: 'bg-yellow-100',
  ...
  'fall-planting': {
    heroBg: 'bg-gradient-to-br from-orange-50 to-amber-200',
    heroBorder: 'border-orange-200',
    heroTitle: 'text-orange-900',
    backBtn: 'text-orange-800 hover:text-orange-950',
    sectionTitle: 'text-orange-900',
  ...
  'post-harvest': {
    heroBg: 'bg-gradient-to-br from-stone-50 to-orange-100',
    heroBorder: 'border-stone-300',
    heroTitle: 'text-stone-800',
    backBtn: 'text-stone-700 hover:text-stone-900',
    sectionTitle: 'text-stone-800',
  ...
  'overwintering': {
    ...
    tipBg: 'bg-slate-50',
    tipBorder: 'border-slate-200',
    tipText: 'text-indigo-950',
    tableHead: 'bg-indigo-100',
    tableHeadText: 'text-indigo-900',
    tableHeadBorder: 'border-indigo-200',
  ...
  'raised-bed-gardening': {
    ...
    tipBorder: 'border-yellow-200',
    tipText: 'text-amber-950',
    tableHead: 'bg-amber-200',
    tableHeadText: 'text-amber-900',
    tableHeadBorder: 'border-amber-300',
    bullet: 'text-amber-700',
  },
  'growing-berries': {
    heroBg: 'bg-gradient-to-br from-indigo-50 to-purple-100',
    heroBorder: 'border-indigo-200',
    heroTitle: 'text-indigo-900',
    backBtn: 'text-indigo-700 hover:text-indigo-900',
    sectionTitle: 'text-indigo-900',
  ...
  'kratky-method': {
    heroBg: 'bg-gradient-to-br from-emerald-50 to-cyan-100',
    heroBorder: 'border-emerald-200',
    heroTitle: 'text-emerald-900',
    backBtn: 'text-emerald-700 hover:text-emerald-900',
    sectionTitle: 'text-emerald-900',
  ...
  'hydroponic-nutrients-ph-ec': {
    heroBg: 'bg-gradient-to-br from-violet-50 to-sky-100',
    heroBorder: 'border-violet-200',
    heroTitle: 'text-violet-900',
    backBtn: 'text-violet-700 hover:text-violet-900',
    sectionTitle: 'text-violet-900',
  ...
  'deep-water-culture': {
    heroBg: 'bg-gradient-to-br from-cyan-50 to-sky-100',
    heroBorder: 'border-cyan-200',
    heroTitle: 'text-cyan-900',
    backBtn: 'text-cyan-700 hover:text-cyan-900',
    ...
    tipBg: 'bg-sky-50',
    tipBorder: 'border-sky-200',
    tipText: 'text-cyan-950',
    tableHead: 'bg-cyan-100',
    tableHeadText: 'text-cyan-900',
    tableHeadBorder: 'border-cyan-200',
    bullet: 'text-cyan-600',
  },
  'nft-hydroponics': {
  ...
  'hydroponic-grow-lights': {
    ...
    heroTitle: 'text-yellow-900',
    backBtn: 'text-yellow-700 hover:text-yellow-900',
    sectionTitle: 'text-yellow-900',
    sectionBorder: 'border-yellow-200',
    h3: 'text-yellow-900',
    tipBg: 'bg-lime-50',
    tipBorder: 'border-lime-200',
    tipText: 'text-yellow-950',
    tableHead: 'bg-yellow-100',
    tableHeadText: 'text-yellow-900',
    tableHeadBorder: 'border-yellow-200',
    bullet: 'text-yellow-600',
  },
  'ebb-and-flow-hydroponics': {
    heroBg: 'bg-gradient-to-br from-teal-50 to-sky-100',
    heroBorder: 'border-teal-200',
    heroTitle: 'text-teal-900',
    backBtn: 'text-teal-700 hover:text-teal-900',
    sectionTitle: 'text-teal-900',
  ...
  'vertical-hydroponic-towers': {
    ...
    backBtn: 'text-fuchsia-700 hover:text-fuchsia-900',
    sectionTitle: 'text-fuchsia-900',
    sectionBorder: 'border-fuchsia-200',
    h3: 'text-fuchsia-900',
    tipBg: 'bg-purple-50',
    tipBorder: 'border-purple-200',
    tipText: 'text-fuchsia-950',
  ...
  'wick-system-hydroponics': {
    ...
    tipBg: 'bg-amber-50',
    tipBorder: 'border-amber-200',
    tipText: 'text-stone-950',
    tableHead: 'bg-stone-100',
    tableHeadText: 'text-stone-900',
    tableHeadBorder: 'border-stone-200',
  ...
  'growing-carrots-root-vegetables': {
    heroBg: 'bg-gradient-to-br from-orange-50 to-amber-100',
    heroBorder: 'border-orange-200',
    heroTitle: 'text-orange-900',
    backBtn: 'text-orange-700 hover:text-orange-900',
  ...
  'growing-figs': {
    heroBg: 'bg-gradient-to-br from-purple-50 to-amber-100',
    heroBorder: 'border-purple-200',
    heroTitle: 'text-purple-900',
    backBtn: 'text-purple-700 hover:text-purple-900',
    sectionTitle: 'text-purple-900',
  ...
  'compost-tea': {
    heroBg: 'bg-gradient-to-br from-amber-50 to-stone-100',
    heroBorder: 'border-amber-200',
    heroTitle: 'text-amber-900',
    backBtn: 'text-amber-700 hover:text-amber-900',
    sectionTitle: 'text-amber-900',
  ...
  'cover-crops': {
    heroBg: 'bg-gradient-to-br from-teal-50 to-stone-100',
    heroBorder: 'border-teal-200',
    heroTitle: 'text-teal-900',
    backBtn: 'text-teal-700 hover:text-teal-900',
    sectionTitle: 'text-teal-900',
  ...
  'hydrangeas': {
    heroBg: 'bg-gradient-to-br from-blue-50 to-violet-100',
    heroBorder: 'border-blue-200',
    heroTitle: 'text-blue-900',
    backBtn: 'text-blue-700 hover:text-blue-900',
    sectionTitle: 'text-blue-900',
  ...
  'growing-garlic-onions': {
    heroBg: 'bg-gradient-to-br from-purple-50 to-fuchsia-100',
    heroBorder: 'border-purple-200',
    heroTitle: 'text-purple-900',
    backBtn: 'text-purple-700 hover:text-purple-900',
    sectionTitle: 'text-purple-900',

...
const questions = [
  {
    ...
    options: [
      ...
      { value: 'vine',        label: 'Vines',             emoji: '🌿', description: 'Climbing and trailing vines for trellises and fences' },
      { value: 'bulb',        label: 'Bulbs',             emoji: '🌷', description: 'Spring and summer flowering bulbs' },
      { value: 'grass',       label: 'Ornamental Grasses',emoji: '🌾', description: 'Decorative grasses for texture and movement' },
      { value: 'succulent',   label: 'Succulents & Cacti',emoji: '🌵', description: 'Drought-tolerant, low-maintenance succulents' },
      { value: 'fern',        label: 'Ferns',             emoji: '🌿', description: 'Lush foliage plants for shady spots' },
      { value: 'groundcover', label: 'Ground Covers',     emoji: '🍀', description: 'Low-growing plants to fill space and suppress weeds' },
    ],
  },
  {
    id: 'growingMethod',

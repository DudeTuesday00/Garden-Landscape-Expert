  ...
  sections: [
    {
      ...
      blocks: [
        ...
        {
          type: 'image',
          src: '/guides/shade-trees/mature-canopy.jpg',
          alt: 'A single massive mature oak tree with a full dense green canopy casting dappled shade over a residential lawn',
          caption: 'One well-placed tree, decades from now, casting exactly this kind of shade — that\'s the payoff for getting the choice right today.',
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'image',
          src: '/guides/shade-trees/sapling-planting-distance.jpg',
          alt: 'A young newly planted tree sapling staked with soft ties, planted in a mulched circle a generous distance from a house',
          caption: 'That small gap between sapling and foundation looks generous now — mature-size math is what makes it the right call.',
        },
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'image',
          src: '/guides/shade-trees/oak-fall-color.jpg',
          alt: 'A majestic solitary maple tree in full vivid red and orange autumn foliage standing in an open field',
          caption: 'Fall color like this is the payoff of picking a maple or oak over a faster, blander grower — the wait is the whole point.',
        },
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'image',
          src: '/guides/shade-trees/root-flare-mulch-donut.jpg',
          alt: 'Close-up of a tree trunk base with a clearly visible flaring root collar and mulch kept a clear gap away from the trunk',
          caption: 'This is what "root flare visible" actually looks like — the trunk should widen and show bark texture change right at soil level, never disappear straight into a mulch pile.',
        },
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'image',
          src: '/guides/shade-trees/soaker-hose-watering.jpg',
          alt: 'A soaker hose coiled in a spiral around the base of a young tree within its mulch ring, water gently seeping into the mulch',
          caption: 'A coiled soaker hose left to run slowly for an hour delivers water exactly where it counts — at the root zone, not running off the surface.',
        },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'h3', text: 'Tree Inventory Checklist Before Buying' },
        {
          type: 'p',
          text: 'Before you hand over your money at the nursery, run through this quick checklist:',
        },
        {
          type: 'list',
          items: [
        ...
        { type: 'h3', text: 'The "Right Tree, Right Place" Philosophy' },
        {
          type: 'p',
          text: 'This phrase is the unofficial motto of professional arborists, and it\'s wisdom that can save you from years of headaches. The perfect shade tree — in the perfect spot — requires dramatically less maintenance, lives dramatically longer, and causes dramatically fewer problems than a tree that\'s fighting its site conditions.',
        },
        {
          type: 'list',
          items: [

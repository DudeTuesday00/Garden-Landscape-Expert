export const sunroomPlantsContent = {
  id: 'sunroom-plants',
  hero: {
    emoji: '🌤️',
    title: 'Sunroom Plants',
    subtitle: 'Turn Your Sunroom Into a Lush Indoor Tropical Garden',
  },
  intro: 'A sunroom is one of the most extraordinary plant environments in any American home — more light than any interior room, more protection than any outdoor garden, and the ability to grow lush tropical plants that would never survive your local winters. This guide teaches you how to choose the right plants for your specific sunroom conditions, design a space that looks genuinely beautiful year-round, and care for tropical plants successfully no matter where in the country you live.',

  sections: [
    {
      id: 'understanding-your-sunroom',
      title: 'Section 1: Understanding Your Sunroom',
      blocks: [
        {
          type: 'p',
          text: 'The single biggest mistake sunroom plant enthusiasts make is buying plants they love and then discovering those plants are completely wrong for their sunroom\'s conditions. A sunroom that faces north with tinted glass is an entirely different growing environment from a south-facing sunroom with clear glass panels — yet both look like "sunny" spaces to the untrained eye. Before you invest in plants, spend a week observing and measuring your sunroom\'s actual conditions.',
        },
        {
          type: 'p',
          text: 'Sunrooms vary enormously in the growing conditions they provide. The same model home in Minnesota and Florida will have radically different interior temperatures, humidity levels, and winter light intensities. The orientation of the glazing, the type of glass, the presence of insulation, and your local climate all combine to create a unique microclimate that determines which plants will succeed and which will struggle.',
        },
        {
          type: 'h3',
          text: 'Sunroom Orientation: The Most Important Variable',
        },
        {
          type: 'p',
          text: 'The direction your sunroom\'s primary glazing faces determines everything about the quantity and quality of light your plants will receive. This single factor should drive the majority of your plant selection decisions.',
        },
        {
          type: 'table',
          headers: ['Orientation', 'Light Quality', 'Summer Conditions', 'Winter Conditions', 'Best Plant Categories'],
          rows: [
        ...
        {
          type: 'h3',
          text: 'Glass Type and Its Effect on Plant Growth',
        },
        {
          type: 'p',
          text: 'Not all sunroom glazing is equal from a plant perspective. The type of glass or polycarbonate panels significantly affects the quality and quantity of light reaching your plants — sometimes dramatically.',
        },
        {
          type: 'list',
          items: [
        ...
        {
          type: 'h3',
          text: 'Temperature: The Critical Limiting Factor',
        },
        {
          type: 'p',
          text: 'Temperature is the factor that most often defeats sunroom plant collections — either because summer temperatures become lethally hot for cool-preferring plants, or because winter temperatures drop below what tropical plants can tolerate. Measuring and managing temperature is essential sunroom gardening knowledge.',
        },
        {
          type: 'table',
          headers: ['Temperature Range', 'Classification', 'Plant Implications', 'U.S. Sunroom Situations'],
          rows: [
        ...
        {
          type: 'h3',
          text: 'Assessing Light Levels',
        },
        {
          type: 'p',
          text: 'Light is measured in foot-candles (fc). Understanding actual light levels — not just "sunny" or "bright" — lets you match plants precisely to positions in your sunroom. A light meter app on a smartphone gives a reasonable reading.',
        },
        {
          type: 'table',
          headers: ['Light Level', 'Foot-Candles', 'Typical Sunroom Location', 'Plants That Thrive'],
          rows: [
    ...
    {
      id: 'best-sunroom-plants',
      title: 'Section 2: The Best Sunroom Plants',
      blocks: [
        {
          type: 'p',
          text: 'The most successful sunroom plant collections share one characteristic: every plant was chosen for the specific conditions of that sunroom, not just for how it looks at the nursery. The following six categories organize sunroom plants by their primary requirements — helping you build a collection where every plant is set up to succeed.',
        },
        {
          type: 'h3',
          text: 'Category 1: The Statement Makers — Bold Tropicals for Sunny Sunrooms',
        },
        {
          type: 'p',
          text: 'These are the plants that make people stop and stare — the ones that make your sunroom look like a greenhouse in the tropics rather than an ordinary sitting room. They require bright direct light and warm temperatures, making them ideal for south and west-facing sunrooms.',
        },
        {
          type: 'table',
          headers: ['Plant', 'Light', 'Temperature', 'Water', 'Key Notes'],
          rows: [
            [
              'Bird of Paradise (Strelitzia reginae / S. nicolai)',
              'Bright direct sun; south or west facing ideal; minimum 4–6 hours direct sun for flowering',
              '65–90°F; tolerates brief dips to 50°F; prefers warm nights (60°F+) for flowering',
              'Allow top 2 inches of soil to dry between waterings; reduce in winter; overwatering is the primary killer',
              'S. reginae (orange flower, 4–5 ft) flowers in sunrooms; S. nicolai (white flower, 6–20 ft) grown for enormous paddle leaves — choose based on ceiling height. Brown leaf tips from low humidity or fluoride in water.',
            ],
            [
              'Bougainvillea',
              'Full direct sun essential — minimum 5–6 hours; will not bloom in indirect light; south-facing sunroom is its natural home',
              '60–90°F growing; tolerates brief dips to 40°F but loses leaves; blooms best with 10°F+ swing between day and night',
              'Let soil dry substantially between waterings — a slightly stressed plant flowers far more freely than a coddled one; overwatered bougainvillea produces leaves, not bracts',
              'High-phosphorus "bloom booster" fertilizer monthly when growing; train on trellis or let cascade; prune after each bloom flush; sharp thorns require gloves. In Zones 9–11, can be trained as a permanent specimen.',
            ],
            [
              'Tropical Hibiscus (Hibiscus rosa-sinensis)',
              'Bright direct to bright indirect; south or west window essential for reliable blooming; 4+ hours direct sun preferred',
              '60–90°F; very cold-sensitive; below 50°F causes leaf and bud drop; keep above 55°F in winter',
              'Consistently moist but not waterlogged; wilts dramatically when dry; self-watering pots work very well',
              'Heavy feeder — fertilize every 2 weeks during growing season; flowers on new growth so prune regularly to encourage branching; whiteflies, aphids, and spider mites are common — inspect weekly.',
            ],
            [
              'Citrus Trees (Meyer Lemon, Calamondin, Kumquat, Key Lime)',
              'Full direct sun essential; south-facing sunroom nearly mandatory north of Zone 8; 6+ hours direct sun for fruiting',
              '55–85°F; keep above 50°F to avoid fruit drop and leaf loss',
              'Consistent moisture without waterlogging; let top inch dry between waterings; citrus drops fruit and leaves dramatically when water-stressed or overwatered',
              'Meyer Lemon is the most reliable indoor fruiter with near-year-round blooms. Use dedicated citrus fertilizer with micronutrients. Self-pollinating but hand-pollinate with a small brush for best fruit set. Blossom fragrance is extraordinary.',
            ],
            [
              'Plumeria (Plumeria spp.)',
              'Full direct sun absolutely required; 6+ hours; south-facing sunroom ideal',
              'Loves heat (75–95°F); suffers below 55°F; dormant plants safe even at 40°F',
              'Allow to dry significantly between waterings; during winter dormancy water barely at all — once monthly is often sufficient',
              'Deciduous in winter — leaves drop completely and plant appears dead; this is normal and healthy, do not overwater. Extraordinary fragrance (vanilla, coconut, spice, or floral depending on cultivar). Tip cuttings root easily — dry cut ends one week before planting.',
            ],
          ],
        },
        {
        ...
        {
          type: 'p',
          text: 'These large-leafed tropicals create the dense, jungle-lush atmosphere that makes a great sunroom feel genuinely immersive. Most prefer bright indirect light, making them adaptable to a wider range of sunroom orientations than the flowering showstoppers above.',
        },
        {
          type: 'table',
          headers: ['Plant', 'Light Need', 'Size', 'Min Temp', 'Standout Feature', 'Difficulty'],
          rows: [
        ...
        {
          type: 'h3',
          text: 'Category 3: The Orchids — Precision Rewarded',
        },
        {
          type: 'p',
          text: 'Orchids are the most diverse family of flowering plants on Earth. The sunroom is an excellent environment for many orchid genera, providing the light variation, temperature differential, and humidity that drives blooming. The key is matching the right orchid genus to your specific sunroom conditions.',
        },
        {
          type: 'table',
          headers: ['Orchid Type', 'Sunroom Light', 'Temperature Need', 'Humidity', 'Bloom Season', 'Notes'],
          rows: [
        ...
        {
          type: 'h3',
          text: 'Category 4: Bromeliads — The Low-Maintenance Showstoppers',
        },
        {
          type: 'p',
          text: 'Bromeliads are among the most rewarding plants for sunroom growing — virtually indestructible, tolerant of inconsistent watering, adaptable to a range of light conditions, and capable of spectacular long-lasting blooms (sometimes 3–6 months). The family includes over 3,000 species.',
        },
        {
          type: 'table',
          headers: ['Bromeliad Type', 'Light', 'Watering Method', 'Humidity', 'Bloom', 'Notes'],
          rows: [
        ...
        {
          type: 'h3',
          text: 'Category 6: Fragrant Sunroom Plants — Engaging All the Senses',
        },
        {
          type: 'p',
          text: 'A sunroom planted with fragrant tropicals becomes a truly immersive sensory experience. The enclosed space concentrates fragrance in a way that\'s impossible in an outdoor garden. These plants are worth seeking out specifically for their scent.',
        },
        {
          type: 'list',
          items: [
    ...
    {
      id: 'quick-reference',
      title: 'Quick Reference: 50 Best Sunroom Plants at a Glance',
      blocks: [
        {
          type: 'p',
          text: 'Use this table to quickly compare plants by light requirement, temperature tolerance, humidity need, size, and difficulty. Organized roughly from most light-demanding to most shade-tolerant.',
        },
        {
          type: 'table',
          headers: ['Plant', 'Light', 'Min Temp', 'Humidity', 'Size', 'Primary Appeal', 'Difficulty'],
          rows: [

export const commonGardenDiseasesContent = {
  ...
  sections: [
...

    {
      ...
      title: 'Section 8: Treatment Options — Organic, Biological & Synthetic',
      blocks: [
        {
          type: 'p',
          text: 'Effective disease management follows an IPM (Integrated Pest Management) hierarchy: begin with cultural and physical controls, escalate to biological controls, and use synthetic fungicides only when the disease pressure, crop value, or risk of spread justifies the additional cost and environmental impact. No spray program substitutes for correct variety selection, proper plant spacing, and sanitation — these cultural practices reduce inoculum load before the season starts.',
        },
        {
          type: 'h3',
          text: 'Organic & Biological Products',
        },
        {
          type: 'table',
          headers: ['Product / Active Ingredient', 'Disease Targets', 'Mode of Action', 'Key Limitations', 'OMRI Listed?'],
          rows: [
            [
              'Copper (copper sulfate, copper hydroxide, copper octanoate)',
              'Bacterial leaf spots, fire blight, downy mildew, late blight, anthracnose',
              'Disrupts pathogen enzyme systems; broad-spectrum protectant',
              'Does not cure established infections; toxic to fish and earthworms with repeated use; can cause copper phytotoxicity on some crops (particularly stone fruits) in cool wet weather',
              'Yes (most formulations)',
            ],
            [
              'Sulfur (elemental or lime-sulfur)',
              'Powdery mildew, rust, scab, black spot on roses',
              'Disrupts cellular respiration in fungal spores on contact',
              'Phytotoxic when temperatures exceed 90°F or within 2 weeks of horticultural oil applications; corrosive; strong odor; avoid on cucurbits and squash (sensitive)',
              'Yes',
            ],
            [
              'Neem oil (azadirachtin + clarified hydrophobic extract)',
              'Powdery mildew, black spot, rust, downy mildew (early), Botrytis',
              'Disrupts spore germination and mycelial growth; some systemic activity via azadirachtin',
              'Breaks down rapidly in UV light; must coat foliage thoroughly; may cause phytotoxicity on stressed plants; ineffective against established infections',
              'Yes (cold-pressed formulations)',
            ],
            [
              'Potassium bicarbonate (e.g., Kaligreen)',
              'Powdery mildew (primary), some rusts',
              'Raises surface pH, disrupting fungal spore germination; draws moisture out of fungal cells',
              'Eradicant activity on existing powdery mildew colonies (works after infection — a key advantage); limited to powdery mildew and a few other surface fungi; high rates can cause salt burn',
              'Yes',
            ],
            [
              'Bacillus subtilis (e.g., Serenade, Cease)',
              'Powdery mildew, downy mildew, Botrytis, Fusarium, Rhizoctonia',
              'Beneficial bacteria produces lipopeptides that destroy fungal cell membranes; also primes plant systemic resistance (SAR)',
              'Requires consistent application intervals (7–10 days); most effective as a preventive; heat and UV degrade viability — apply in early morning',
              'Yes',
            ],
            [
              'Trichoderma spp. (e.g., RootShield, T-22)',
              'Soilborne pathogens: Pythium, Phytophthora, Fusarium, Rhizoctonia',
              'Beneficial fungi colonize roots and out-compete pathogens; produce enzymes that parasitize fungal hyphae; induce host resistance',
              'Soil-applied only; no foliar activity; best used as drench or transplant dip; maintain soil moisture for establishment; efficacy reduced by high fungicide applications',
              'Yes',
            ],
            [
              'Reynoutria sachalinensis extract (e.g., Regalia)',
              'Powdery mildew, downy mildew, Botrytis, bacterial diseases',
              'Plant extract that stimulates plant systemic acquired resistance (SAR) — the plant defends itself; no direct antimicrobial activity',
              'Works best preventively (before infection); typically tank-mixed with other fungicides to improve efficacy; 4–5 day window before resistance is fully activated',
              'Yes',
            ],
          ],
        },
        {
          type: 'h3',
          text: 'Synthetic Fungicides',
        },
        {
          type: 'p',
          text: 'Synthetic fungicides are grouped by FRAC (Fungicide Resistance Action Committee) code based on their biochemical mode of action. Rotating between FRAC groups is essential to prevent resistance development. Never apply the same FRAC group more than twice consecutively.',
        },
        {
          type: 'table',
          headers: ['FRAC Group / Class', 'Common Active Ingredients', 'Disease Targets', 'Systemic?', 'Key Notes'],
          rows: [
            [
              'FRAC 3 — DMI / Triazoles',
              'Propiconazole, myclobutanil, tebuconazole, tetraconazole',
              'Powdery mildew, rust, scab, brown rot, black spot',
              'Yes — upward systemic movement',
              'Excellent curative activity (up to 72 hrs post-infection); widely available in home-garden products; moderate resistance risk — always rotate with non-DMI groups',
            ],
            [
              'FRAC 7 — SDHI / Carboxamides',
              'Boscalid, fluopyram, penthiopyram',
              'Powdery mildew, Botrytis, rust, Rhizoctonia, Sclerotinia',
              'Yes — locally systemic',
              'High-performance class; high resistance risk — limit to 2 consecutive applications; often pre-mixed with FRAC 11 (strobilurins) for rotational convenience',
            ],
            [
              'FRAC 11 — QoI / Strobilurins',
              'Azoxystrobin, pyraclostrobin, trifloxystrobin',
              'Broad-spectrum: powdery mildew, downy mildew, anthracnose, rust, blight, Botrytis',
              'Yes — systemic and translaminar',
              'Very high resistance risk — resistance confirmed in powdery mildews, gray mold, and downy mildews worldwide; never use alone; always in mixtures; maximum 2 applications per season per site',
            ],
            [
              'FRAC 12 — Phenylpyrroles',
              'Fludioxonil',
              'Botrytis, Fusarium, Rhizoctonia, Sclerotinia (soilborne)',
              'No — contact only',
              'Very low resistance risk; excellent for Botrytis rotation partner; often combined with cyprodinil (FRAC 9) in commercial products; soil drench or spray',
            ],
            [
              'FRAC 17 — Hydroxyanilide',
              'Fenhexamid (Decree)',
              'Botrytis gray mold (very specific)',
              'No — contact/local',
              'Highly specific to Botrytis; excellent rotation partner; moderate resistance risk if used exclusively; most useful on high-value crops (strawberry, wine grapes)',
            ],
            [
              'FRAC 21 — Complex III / Oxazolidinediones',
              'Cyazofamid, ametoctradin',
              'Oomycete diseases: downy mildew, late blight, Pythium, Phytophthora',
              'Locally systemic',
              'Oomycete-specific; critical for late blight on potatoes/tomatoes; rotate with FRAC 40 (mandipropamid) and phosphonates (FRAC 33)',
            ],
            [
              'FRAC 40 — Mandipropamid',
              'Mandipropamid (Revus)',
              'Downy mildew, late blight, Phytophthora',
              'Yes — translaminar',
              'Excellent rainfastness (rain-resistant within 60 minutes); oomycete-only; low resistance risk relative to FRAC 11; key tool in late blight programs',
            ],
            [
              'FRAC 33 — Phosphonates',
              'Phosphorous acid, fosetyl-aluminum (Aliette)',
              'Phytophthora, Pythium, downy mildew',
              'Yes — bidirectional (up and down)',
              'Unique bidirectional movement reaches roots from foliar application; used as both preventive and curative; also stimulates plant defense responses; labeled for soil drench or foliar on many crops',
            ],
            [
              'FRAC M (Multi-site) — Chloronitriles & Phthalimides',
              'Chlorothalonil, mancozeb, captan, thiram',
              'Broad-spectrum protectant: blight, leaf spots, rust, scab',
              'No — contact/protectant only',
              'No resistance risk (multi-site mode of action); must be applied before infection; excellent as rotation base; some formulations restricted for homeowner use; pre-harvest interval (PHI) requirements vary',
            ],
          ],
        },
        {
          type: 'warning',
          emoji: '⚠️',
          text: 'Resistance management is not optional. Single-site fungicides (FRAC 3, 7, 11, 12, 17, 40) face resistance in many pathogen populations. Always rotate FRAC groups with every application. Read the label for maximum applications per season per site. Tank-mixing a single-site fungicide with a multi-site protectant (mancozeb, chlorothalonil, captan) reduces resistance pressure and improves coverage. "If in doubt, rotate out" — apply a different FRAC group before any sign of reduced efficacy.',
        },
        {
          type: 'tip',
          emoji: '📅',
          text: 'Timing matters more than product choice. A protectant spray applied before infection outperforms a curative spray applied after symptoms are visible. In high-pressure disease years (wet springs, warm nights), begin your spray program at first green tip or planting, not after you see disease. Most fungicide labels specify a "spray interval" — typically 7–14 days — which is the maximum protection window under ideal conditions. Shorten intervals during wet weather.',
        },
      ],
    },
  ],

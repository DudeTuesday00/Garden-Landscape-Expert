export const indoorHerbGardenContent = {
  ...
  sections: [
    ...
    {
      id: 'design-hydroponics',
      title: 'Section 7: Design, Layout & Hydroponics',
      blocks: [
        {
          type: 'p',
          text: 'An indoor herb garden can be a purely functional arrangement — plants on a windowsill, optimized for light and access — or it can be a design feature of your kitchen that is beautiful to look at every day while also being productive and practical. The best indoor herb gardens are both: thoughtfully arranged to maximize growing conditions while also creating an aesthetic that enhances the kitchen space.',
        },
        {
          type: 'h3',
          text: 'Setup Options: Finding the Right Arrangement',
        },
        {
          type: 'table',
          headers: ['Setup Type', 'Space Required', 'Light Source', 'Best Herbs', 'Approximate Cost', 'Ideal For'],
          rows: [
            [
              'Simple south windowsill',
              'Standard kitchen windowsill (12–30 in wide)',
              'Natural south-facing light',
              'Basil, chives, parsley, thyme, oregano in summer; chives and parsley year-round',
              '$20–50 (containers only)',
              'Kitchens with excellent south-facing light; warm climates (Zone 7+); anyone starting simply',
            ],
            [
              'Window box / long planter',
              '24–48 in windowsill length',
              'Natural south or west window',
              'Row of 4–6 herbs in one long container; herbs with compatible water needs grouped together',
              '$30–80 (planter + plants)',
              'Visual cohesion; kitchens with wide windowsills; people who want a "designed" look',
            ],
            [
              'Over-the-sink herb garden',
              'Above or alongside kitchen sink',
              'Natural skylight or supplemental LED strip',
              'Culinary herbs used most often (basil, chives, parsley, thyme)',
              '$50–150 (hanging shelf or brackets + grow lights)',
              'Keeping herbs within reach of where you cook most; dramatic visual focal point',
            ],
            [
              'Counter-top grow light setup',
              '12–18 in of counter space',
              'Dedicated tabletop LED grow light',
              'Any herbs; especially basil, cilantro, parsley — herbs that need consistent light',
              '$80–200 (light + containers)',
              'Kitchens with poor natural light; northern climates; year-round serious herb growing',
            ],
            [
              'Wire shelving grow light system',
              '24–48 in wide, 18–24 in deep; floor space',
              'LED strips mounted under each shelf',
              '20–40 herb plants; all varieties including Mediterranean; maximum production',
              '$150–350 (shelving + lights + containers)',
              'Serious herb growers; cooks who use large quantities; all-season high-production setups',
            ],
            [
              'Under-cabinet LED strip lights',
              'Existing counter space below cabinets',
              'LED strips mounted to cabinet undersides',
              'Most culinary herbs on the counter directly below cabinets',
              '$50–150 (LED strips + timer + containers)',
              'Kitchens with cabinets above counters; aesthetically seamless; doubles as task lighting',
            ],
            [
              'Hanging herb garden',
              'Wall space; 12–18 in deep shelf',
              'Near window or grow light strip',
              'Trailing herbs (trailing thyme, mint in hanging pots); herbs in hanging baskets',
              '$60–150 (wall shelf + hooks + containers)',
              'Small kitchens with limited counter space; decorative emphasis; apartment kitchens',
            ],
            [
              'Hydroponic herb kit',
              'Compact countertop footprint',
              'Built-in grow lights (included)',
              'Basil, cilantro, mint, chives, parsley — fast-growing herbs ideal for hydro',
              '$80–300 (all-in-one systems like AeroGarden, Click & Grow)',
              'Beginners who want a complete system; anyone who wants minimal setup and guaranteed light; gift option',
            ],
          ],
        },
        {
          type: 'h3',
          text: 'Herb Garden Design Principles',
        },
        {
          type: 'list',
          items: [
        ...
        {
          type: 'h3',
          text: 'Hydroponic Herb Growing: The High-Tech Option',
        },
        {
          type: 'p',
          text: 'Countertop hydroponic systems have become popular kitchen appliances over the past decade, with systems like AeroGarden, Click & Grow, and similar products making entry-level hydroponic herb growing accessible to anyone. These systems eliminate soil, provide built-in grow lights on timers, and use nutrient-enriched water to grow herbs faster than soil-based methods.',
        },
        {
          type: 'table',
          headers: ['Factor', 'Details'],
          rows: [
            ['Advantages', 'Complete turnkey system; built-in lighting eliminates the light problem; no soil mess; very fast growth (often 2–3x faster than soil); automated water and nutrient delivery; excellent for beginners; no drainage concerns'],
            ['Disadvantages', 'More expensive upfront; replacement pods or nutrients are an ongoing cost; herbs often outgrow systems quickly; some systems have limited pod capacity (3–9 plants); not all herbs are suitable'],
            ['Best herbs for hydro', 'Basil (thrives — fastest of any hydroponic herb), mint, chives, parsley, cilantro, dill, and most fast-growing leafy herbs. Mediterranean woody herbs (rosemary, thyme, sage) are less successful.'],
            ['Popular systems', 'AeroGarden: Most widely available; various sizes (3–24 pod models); pods are proprietary but plants can be grown from seed in the pod holders. Click & Grow: Uses plant "pods" with soil-like substrate; very easy; attractive design. DIY Kratky: A passive, inexpensive method using any container — popular among serious herb growers.'],
            ['Cost reality', 'Entry-level 3–6 pod systems: $50–100. Mid-range 7–12 pod systems: $100–200. Pod refills: $5–15 per pod. Electricity: $3–8/month. Higher cost than soil growing, but convenience is significantly greater for many users.'],
          ],
        },
        {
          type: 'tip',
          emoji: '💡',
          text: 'Hydroponic systems are an excellent gift option for someone who wants to grow herbs but is intimidated by soil-based growing. The all-in-one format eliminates most failure modes for beginners. Once confident, many hydroponic growers expand to soil-based growing to access a wider range of herbs.',
        },
      ],
    },
    {

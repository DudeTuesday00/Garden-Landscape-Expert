export const zenGardenContent = {
  id: 'zen-garden',
  hero: {
    emoji: '🪨',
    title: 'Zen Garden Design',
    subtitle: 'Create a Peaceful, Minimalist Garden for Meditation and Mindfulness',
  },
  intro: 'The word "Zen garden" in Western usage has come to describe almost any garden with Asian visual influences — a bamboo fence here, a stone lantern there, some ornamental grasses. This is not what a Zen garden is. A genuine Zen garden begins with a philosophical question rather than an aesthetic one: What kind of space will help a person be present?',
  sections: [
    {
      id: 'overview',
      title: 'What a Zen Garden Actually Is',
      blocks: [
        {
          type: 'p',
          text: 'The Japanese dry garden tradition — karesansui — emerged from Zen Buddhist monastery culture in the 12th through 16th centuries, when monks designed outdoor spaces not for pleasure or food production but for contemplation. The famous gardens of Ryoanji and Daisen-in in Kyoto are not decorative; they are environments designed to quiet the mind, dissolve distraction, and support the conditions of insight. Every element is chosen and placed to serve that purpose. What is not needed is removed. What remains is arranged with complete attention.',
        },
        {
          type: 'p',
          text: 'This guide takes that purpose seriously while making it fully accessible to American gardeners of any background, in any climate, with any amount of space. A genuine Zen garden does not require Japanese plants or Japanese ornaments. It requires a particular quality of attention in its design and a particular quality of presence in its use. The principles here will show you how to create that — whether in an acre of formal garden or a ten-foot courtyard or a balcony arrangement of gravel and stone.',
        },
        {
          type: 'p',
          text: 'This guide is organized to move from philosophy into practice in a sequence that mirrors good garden design: understanding what you are trying to create before deciding how to create it. The philosophical foundations in Section 1 are not preamble — they are the most important section in the guide, because every material decision that follows is an expression of them.',
        },
        {
          type: 'h3',
          text: 'The Seven Principles at a Glance',
        },
        {
          type: 'table',
          headers: ['Principle', 'Japanese Concept', 'In the Garden', 'Design Application'],
          rows: [
            [
              'Asymmetry',
              'Fukinsei',
              'Nature is not symmetrical. Even the most carefully composed Zen garden avoids mirror symmetry, even numbers, and paired placement.',
              'Use odd numbers of stones (3, 5, 7). Place focal elements off-center. Let paths curve rather than run straight to the midpoint.',
            ],
            [
              'Simplicity',
              'Kanso',
              'The garden contains only what is necessary. Every element present earns its presence. What can be removed, is removed.',
              'Edit relentlessly. If you are uncertain whether an element belongs, remove it and observe the garden without it for a week. The garden that needs nothing added is finished.',
            ],
            [
              'Austere Elegance',
              'Koko',
              'Beauty in restraint, age, and the quality of things that have been worn smooth by time and weather. Not ornate, not new.',
              'Choose materials that age beautifully: natural stone, weathered wood, aged ceramic. Avoid plastic, bright colors, synthetic materials. Welcome moss and lichen as the garden matures.',
            ],
            [
              'Naturalness',
              'Shizen',
              'The garden suggests nature without imitating it directly. Stones are placed as mountains, gravel raked as water — not to reproduce these things but to evoke them.',
              'Avoid the obviously artificial. No precisely geometric shapes. No perfectly smooth or polished surfaces. Let natural material speak in its own character.',
            ],
            [
              'Subtle Mystery',
              'Yugen',
              'The quality of depth and incompleteness. A garden that reveals itself all at once is fully understood in a moment and forgotten. A garden that suggests what it does not show is inexhaustible.',
              'Create a path that disappears around a planting. Place a stone partially buried so its full extent is unknown. Frame a view through a gate that shows only part of what is beyond.',
            ],
            [
              'Freedom from Convention',
              'Datsuzoku',
              'Within the ordered whole, a quality of the unexpected. A single stone of unusual character in a field of gravel. One asymmetric element that the eye catches and returns to.',
              'Allow one element to break the visual expectation — not many, not randomly, but one deliberate, composed surprise.',
            ],
            [
              'Stillness',
              'Seijaku',
              'The experience the garden is designed to produce: active, alive stillness. Not emptiness, but the quality of silence that is full rather than absent.',
              'Every design decision serves this quality. The sound of water over stone; the shadow of a branch on gravel; the mossed surface of an old rock. These are not decorations. They are the garden\'s purpose.',
            ],
          ],
        },

...
export const fourSeasonGardenContent = {
  ...
  sections: [
    ...
    /* ── Section 10: Quick Reference — 50 Essential Plants + Closing ── */
    {
      id: 'quick-reference',
      title: 'Quick Reference: 50 Essential Four-Season Garden Plants',
      blocks: [
        {
          type: 'p',
          text: 'These 50 plants form the backbone of a well-designed year-round American garden. Adapted for Zones 4–8 as a baseline; check zone ratings and substitute regionally appropriate alternatives where needed.',
        },
        {
          type: 'table',
          headers: ['Plant Name', 'Type', 'Zones', 'Peak Season(s)', 'Primary Value'],
          rows: [
            ['Serviceberry (Amelanchier)', 'Native tree/shrub', '3–9', 'Spring, Fall', 'Spring flowers, summer berries, fall color, winter bark'],
            ['Oakleaf Hydrangea', 'Shrub', '5–9', 'Summer, Fall/Winter', 'Summer flowers, fall color, exfoliating bark, persistent flowerheads'],
            ['Winterberry Holly', 'Native shrub', '3–9', 'Fall/Winter', 'Brilliant red berries; habitat plant'],
            ['Fothergilla', 'Native shrub', '4–8', 'Spring, Fall', 'Bottlebrush spring flowers, exceptional fall color'],
            ['Viburnum (native spp.)', 'Shrub', '4–8', 'Spring, Fall/Winter', 'Spring flowers, fall berries, bird magnet'],
            ['Witch Hazel (Hamamelis)', 'Shrub/tree', '3–9', 'Late Winter/Spring', 'Late winter to early spring flowers — first bloomer'],
            ['Eastern Redbud', 'Native tree', '4–9', 'Spring, Fall', 'Magenta spring bloom; yellow-green summer foliage; fall color'],
            ['River Birch', 'Native tree', '4–9', 'All year', 'Exfoliating bark; wildlife value; yellow fall color'],
            ['Ornamental Crabapple', 'Tree', '4–8', 'Spring, Fall/Winter', 'Spring flowers, persistent fall/winter fruit'],
            ['Karl Foerster Grass', 'Grass', '4–9', 'Summer–Winter', 'Vertical structure; feathery plumes; winter persistence'],
            ['Switchgrass (Panicum)', 'Native grass', '3–9', 'Summer–Winter', 'Native; burgundy fall color; winter structure'],
            ['Little Bluestem', 'Native grass', '3–9', 'Summer–Winter', 'Native; copper-orange fall color; fluffy white seeds'],
            ['Purple Coneflower (Echinacea)', 'Native perennial', '3–9', 'Summer, Fall/Winter', 'Long bloom; seedheads for birds; drought tolerant'],
            ['Black-eyed Susan (Rudbeckia)', 'Native perennial', '3–10', 'Summer–Fall', 'Extended bloom; glowing fall seedheads'],
            ['New England Aster', 'Native perennial', '3–8', 'Fall', 'Peak fall color; butterfly magnet; excellent purple'],
            ['Goldenrod (Solidago)', 'Native perennial', '3–9', 'Fall', 'Native; pollinator powerhouse; feathery gold'],
            ['Sedum (Hylotelephium)', 'Perennial', '3–9', 'Summer–Winter', 'Late summer/fall flowers; copper seedheads persist'],
            ['Hellebore', 'Evergreen perennial', '4–9', 'Late Winter–Spring', 'Earliest bloomer; evergreen; deer resistant'],
            ['Baptisia (wild indigo)', 'Native perennial', '3–9', 'Spring, Fall/Winter', 'Native; spring flowers; dramatic black seedpods'],
            ['Catmint (Nepeta)', 'Perennial', '3–8', 'Spring–Fall', 'Reblooms 3x; blue-lavender; long season'],
            ['Peony (Paeonia)', 'Perennial', '3–8', 'Late Spring', 'Showstopping fragrant blooms; 50+ year lifespan'],
            ['Ornamental Allium', 'Bulb', '4–8', 'Late Spring', 'Structural purple globes; bridge spring to summer'],
            ['Daffodil (Narcissus)', 'Bulb', '3–8', 'Spring', 'Deer resistant; naturalizes reliably; wide variety'],
            ['Crocus (species)', 'Corm', '3–8', 'Early Spring', 'First color; plant by the hundreds'],
            ['Snowdrop (Galanthus)', 'Bulb', '3–7', 'Late Winter', 'Earliest bulb; naturalizes beautifully under trees'],
            ['Agastache (hyssop)', 'Perennial', '5–10', 'Summer–Fall', 'Drought tolerant; long bloom; hummingbirds'],
            ['Monarda (bee balm)', 'Native perennial', '3–9', 'Summer', 'Native; hummingbird and butterfly magnet'],
            ['Garden Phlox', 'Perennial', '3–8', 'Summer', 'Fragrant; bold color; mid-late summer'],
            ['Bleeding Heart (Dicentra)', 'Perennial', '3–9', 'Spring', 'Shade; elegant early perennial'],
            ['Japanese Anemone', 'Perennial', '4–8', 'Late Summer–Fall', 'Delicate late-season flowers in shade or sun'],
            ['Red-twig Dogwood', 'Native shrub', '2–9', 'Winter', 'Brilliant stem color; native; wet tolerant'],
            ['Beautyberry (Callicarpa)', 'Shrub', '5–8', 'Fall–Winter', 'Stunning magenta berries; deer resistant'],
            ['Coral Bells (Heuchera)', 'Perennial', '3–9', 'All year', 'Evergreen or semi-evergreen foliage in wide colors'],
            ['Hosta', 'Perennial', '3–8', 'Summer', 'Shade king; enormous foliage variety and texture'],
            ['Caladium', 'Tender bulb', 'Annual/9–11', 'Summer', 'Spectacular tropical foliage; shade or sun varieties'],
            ['Coleus (Solenostemon)', 'Annual', 'Annual/10+', 'Summer', 'Foliage star; near-infinite color variety'],
            ['Toad Lily (Tricyrtis)', 'Perennial', '4–9', 'Fall', 'Orchid-like fall flowers; shade gem'],
            ['Joe-pye Weed (Eutrochium)', 'Native perennial', '3–9', 'Late Summer–Fall', 'Tall native; monarch butterfly magnet'],
            ['Vernonia (ironweed)', 'Native perennial', '4–9', 'Late Summer', 'Vivid purple native; late season pollinator plant'],
            ['Rattlesnake Master (Eryngium)', 'Native perennial', '3–8', 'Summer, Fall/Winter', 'Architectural; spiky; dramatic winter form'],
            ['Prairie Dropseed (Sporobolus)', 'Native grass', '3–9', 'Summer–Fall', 'Fine-textured native grass; fragrant seed'],
            ['Mahonia (grape holly)', 'Evergreen shrub', '5–9', 'Winter–Spring', 'Yellow winter flowers; blue berries; evergreen structure'],
            ['Inkberry Holly (Ilex glabra)', 'Native shrub', '4–9', 'All year', 'Native evergreen; black berries; wildlife value'],
            ['Carolina Allspice (Calycanthus)', 'Native shrub', '4–9', 'Spring–Summer', 'Fragrant burgundy flowers; yellow fall color'],
            ['Firethorn (Pyracantha)', 'Shrub', '6–9', 'Fall–Winter', 'Orange-red berries; evergreen; spectacular winter show'],
            ['Paperbark Maple', 'Tree', '4–8', 'All year', 'Extraordinary cinnamon exfoliating bark; year-round star'],
            ['Dawn Redwood', 'Tree', '4–8', 'All year', 'Fast-growing; feathery needles; orange fall color; interesting structure'],
            ['Native Blueberry (Vaccinium)', 'Native shrub', '3–9', 'Spring, Summer, Fall', 'Edible; spring flowers; summer fruit; brilliant fall color'],
            ['Lenten Rose (Helleborus)', 'Evergreen perennial', '4–9', 'Winter–Spring', 'Earliest bloomer; evergreen; long-lived'],
            ['Beautyberry (Callicarpa americana)', 'Native shrub', '6–10', 'Fall', 'Showstopping native; most vivid berries in the garden'],
          ],
        },
        {
          type: 'h3',
          text: 'Every Month Is an Opportunity',
        },
        {
          type: 'p',
          text: 'The gardener who designs for all four seasons doesn\'t just have a more beautiful garden — they have a garden they actually use in February, seek out in October, and feel proud of in January. That\'s the real reward. Not just peak summer color, but a living, changing composition that earns its place in your life for all twelve months.',
        },
        {
          type: 'tip',
          emoji: '🌱',
          text: 'Now go plant something for January.',
        },
      ],
    },
  ],

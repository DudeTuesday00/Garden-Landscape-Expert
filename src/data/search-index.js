...
import { guideCount } from './site-stats.js'
...
const staticPages = [
  ...
  { title: 'Hydroponic System Chooser', emoji: '🫙', description: 'Find the right home hydroponic system for your space, budget, and time.', href: '/tools/hydroponic-system-chooser/' },
  ...
  { title: 'Plantopedia', emoji: '📖', description: `Browse ${guideCount} expert growing guides by category.`, href: '/guides/' },

...
export const metadata = {
  ...
  description: 'A personalized garden planting calendar by ZIP code — when to start seeds indoors, plant outdoors, and harvest, for 148 plants across 12 categories, not just vegetables.',
  alternates: {
  ...
  openGraph: {
    ...
    description: 'Your personalized planting calendar by ZIP code — for 148 plants, not just vegetables.',
  },
  twitter: {
    title: 'Garden Planting Calendar | Planting Atlas',
    description: 'Your personalized planting calendar by ZIP code — for 148 plants, not just vegetables.',

...
- `src/data/guides.js` — 10 categories, ~75 guides (14 live, remainder `comingSoon: true`)
...
2. Flowers & Color Gardens (9 guides — 6 live ✅)
...
Fourteen full guides built out from source `.docx` files and integrated into the app:

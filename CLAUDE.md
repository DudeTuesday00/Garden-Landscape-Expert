...
- `src/data/guides.js` — 10 categories, ~75 guides (16 live, remainder `comingSoon: true`)
...
2. Flowers & Color Gardens (9 guides — 8 live ✅)
...
Sixteen full guides built out from source `.docx` files and integrated into the app:
